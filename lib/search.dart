                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(
                        width: 290,
                        child: Text(actors_set.toList()[index], style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      ),
                      // SizedBox(width: 260),
                      IconButton(
                        icon: actor_index[index] == 1
                            ? Icon(Icons.favorite)
                            : Icon(Icons.favorite_border),
                        color: Colors.red,
                        onPressed: () {
                          setState(() {
                            if (actor_index[index] == 1) {
                              actor_index[index] = 0;
                              favorite_actors
                                  .remove(actors_set.toList()[index]);
                              FirebaseFirestore.instance
                                  .collection('user')
                                  .doc(FirebaseAuth.instance.currentUser!.uid)
                                  .set({
